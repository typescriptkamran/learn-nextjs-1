...
function ExpandingArrow({ className }) {
    return (<div className="group relative flex items-center">
      <svg className={`${className ? className : 'h-4 w-4'} absolute transition-all group-hover:translate-x-1 group-hover:opacity-0`} xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" width="16" height="16">
      ...
      <svg className={`${className ? className : 'h-4 w-4'} absolute opacity-0 transition-all group-hover:translate-x-1 group-hover:opacity-100`} xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" width="16" height="16">
